...
class CasaAlone extends StatefulWidget {
  @override
  _CasaAloneState createState() => _CasaAloneState();
  final list;
  CasaAlone({this.list});

}

class _CasaAloneState extends State<CasaAlone> with AutomaticKeepAliveClientMixin{
  dynamic aloneView;
