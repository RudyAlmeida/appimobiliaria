...
class TerrenoAlone extends StatefulWidget {
  @override
  _TerrenoAloneState createState() => _TerrenoAloneState();
  final List list;

  TerrenoAlone({this.list});
}

class _TerrenoAloneState extends State<TerrenoAlone> with AutomaticKeepAliveClientMixin{
  dynamic aloneView;
