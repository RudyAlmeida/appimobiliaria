...
import 'package:imobiliaria_gigante/ui/casa_alone.dart';

class CasasView extends StatefulWidget {
  @override
  _CasasViewState createState() => _CasasViewState();
}

class _CasasViewState extends State<CasasView> {
  DatabaseReference dbRef = FirebaseDatabase.instance.reference().child("casas");
  List list =  List();
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    SizedBox(width: 10.0,),
                    Expanded(
                      child: Text("Sem Casas no momento",
