...
import 'package:imobiliaria_gigante/ui/apartamento_alone.dart';

class ApView extends StatefulWidget {
  @override
  _ApViewState createState() => _ApViewState();
}

class _ApViewState extends State<ApView> {
  DatabaseReference dbRef = FirebaseDatabase.instance.reference().child("predios");
  List list =  List();
      ...
      FutureBuilder(
          ...
          builder: (context, AsyncSnapshot<DataSnapshot> snapshot) {
            if (snapshot.hasData) {
              ...
              Text('Sem Apartamentos no momento');
            }
            return  Card(
              elevation: 20,
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    SizedBox(width: 10.0,),
                    Expanded(
                      child: Text("Sem Apartamentos no momento",
...
//                            Image(image: NetworkImage(list[index]["foto"]),)
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Edifício: " + list[index]["edificio"],
                      overflow: TextOverflow.ellipsis,
                      style: TextStyle(
                    ...
                    Row(
                      children: <Widget>[
                        Text("Quartos: "+ list[index]["quartos"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              fontSize: 12.0),
                        ),
                        SizedBox(width: 10.0,),
                        Text("Banheiros: "+ list[index]["banheiros"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              fontSize: 12.0),
                        ),
                        SizedBox(width: 10.0,),
                        Text("Vagas: "+ list[index]["vagas"],
                          overflow: TextOverflow.ellipsis,
                          style: TextStyle(
                              fontSize: 12.0),
                        ),
